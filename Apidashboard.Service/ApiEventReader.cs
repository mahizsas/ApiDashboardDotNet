			...
			while (true)
			{
				try
				{
					var factory = new ConnectionFactory
						{
							...
							HostName = "rabbitmqprod.groupcommerce.com",
							UserName = "api",
							Password = "",
					...
					using (var channel = conn.CreateModel())
					{
						...
						//queue will be given random name, since it's non-durable we don't need to have a known queue name
						var durable = false;
						var exclusive = true;
						var autoDelete = true;
				...
				{
					//this is a demo app, nothing fancy
				}
			}
		}
